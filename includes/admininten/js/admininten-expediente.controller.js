(function() {
    ...
    angular.module('Controllers')
        .controller('adminintenExpedienteController', adminintenExpedienteController);

    adminintenExpedienteController.$injet = ['LxDialogService', 'LxDatePickerService', '$http', '$httpParamSerializerJQLike', 
                                        'SessionService', 'vcRecaptchaService'];

    function adminintenExpedienteController(LxDialogService, $http, $httpParamSerializerJQLike, 
                                        SessionService) {
        var vm = this;
