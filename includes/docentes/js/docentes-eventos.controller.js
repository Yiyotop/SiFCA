(function() {
    ...
    angular.module('Controllers')
        .controller('docentesEventosController', docentesEventosController);

    docentesEventosController.$injet = ['LxDialogService', '$http', '$httpParamSerializerJQLike', 
                                        'SessionService' ];

    function docentesEventosController(LxDialogService, $http, $httpParamSerializerJQLike, 
                                        SessionService ) {
        var vm = this;
        ...
        function leerEventos() { 
            ...
            $http({
                ...
                url: '/siiFCA/api/leer_eventos_docente.php'
            })
