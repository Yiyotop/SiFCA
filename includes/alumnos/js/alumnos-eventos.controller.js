(function() {
    ...
    angular.module('Controllers')
        .controller('alumnosEventosController', alumnosEventosController);

    alumnosEventosController.$injet = ['LxDialogService', '$http', '$httpParamSerializerJQLike', 
                                        'SessionService'];

    function alumnosEventosController(LxDialogService, $http, $httpParamSerializerJQLike, 
                                        SessionService ) {
        var vm = this;
        ...
        function leerEventos() { 
            ...
            $http({
                ...
                url: '/siiFCA/api/leer_eventos_alumno.php'
            })
        ...
        function registroEvento(idevento) { 
            ...
            $http({
                ...
                data: $httpParamSerializerJQLike(datosEnviar),
                headers: { 'Content-Type': 'application/x-www-form-urlencoded','Data-Type': 'html' },
                url: '/siiFCA/api/registro_evento_alumno.php'
            })
            .then( function ok(resp) {
                vm.showLinearProgress = false;
                vm.enviado = false;
        ...
        function cancelarRegistroEvento(idevento) { 
            ...
            $http({
                ...
                data: $httpParamSerializerJQLike(datosEnviar),
                headers: { 'Content-Type': 'application/x-www-form-urlencoded','Data-Type': 'html' },
                url: '/siiFCA/api/cancelar_registro_evento_alumno.php'
            })
            .then( function ok(resp) {
                vm.showLinearProgress = false;
                vm.enviado = false;
